...
\]
The development defines measurable terminal-state, jump-time, and right-continuous trajectory maps on this carrier. All path measures in this paper, including the global driven laws of Section~\ref{sec:driven}, live on this dependent sum of finite jump records, equipped with measurable right-continuous real-time evaluation maps; we do not construct the laws directly on a canonical Skorokhod space of c\`adl\`ag functions.
