...
\label{eq:terminal-exp}
  ...
  = \exp(TQ)(x,y),
\end{equation}
where $\operatorname{toReal}$, matching the Lean coercion of the same name, converts an extended-nonnegative-real mass to its real value: the left-hand side is a finite singleton mass, read as a real number.
