...
\end{equation}
The identity is proved by integrating out the last free simplex coordinate: splitting the $N$th arrival integral according to whether the remaining time survives without a further jump produces exactly the $N$th completed-sector mass plus the $(N{+}1)$st arrival mass, and the partial sums telescope from $A_0(T,x)=1$.
