...
\midrule
1 & Nonzero normalized free-simplex reference (scaled by the sector mass $T^n/n!$) and simplex volume & \file{ContinuousTimeJumpSimplex.lean}:\newline \mbox{\lean{Simplex.volume_freeSimplexSet}},\newline \mbox{\lean{Simplex.sum_holdingTimesOfFree}} \\
\addlinespace
